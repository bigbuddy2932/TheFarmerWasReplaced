...
CONST_EGG_QUOTA = get_world_size() * get_world_size() * 8
CONST_BONES_QUOTA = get_world_size() * get_world_size() * 64
...
default_quotas = {Items.Hay: CONST_HAY_QUOTA, Items.Wood: CONST_WOOD_QUOTA, Items.Water_Tank: CONST_WATER_TANK_QUOTA,
                  ...
                  Items.Cactus: CONST_CACTUS_QUOTA, Items.Egg: CONST_EGG_QUOTA, Items.Bones: CONST_BONES_QUOTA}

quotas = {}

auto_unlock_candidates = [Unlocks.Grass, Unlocks.Expand, Unlocks.Speed, Unlocks.Carrots, Unlocks.Benchmark,
                          Unlocks.Debug_2, Unlocks.Sunflowers, Unlocks.Dinosaurs, Unlocks.Auto_Unlock,
                          Unlocks.Leaderboard, Unlocks.Pumpkins, Unlocks.Mazes, Unlocks.Debug, Unlocks.Trees,
                          Unlocks.Watering, Unlocks.Multi_Trade, Unlocks.Cactus]
